...
<div class="col-sm-3">
    <div class="panel panel-default">
        <div class="panel-body text-center">
            <div class="thumbnail">
                <img src="${SITE_URL}/asset/img/avatar-img/${sessionScope.user.getUrl_image()}" class="img-responsive">
            </div>
            <p><span class="label label-default">Standard User</span></p>
            <p><strong>${sessionScope.user.getFirst_name()} ${sessionScope.user.getLast_name()}</strong></p>
